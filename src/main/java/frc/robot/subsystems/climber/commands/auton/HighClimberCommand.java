...
public class HighClimberCommand extends CommandBase {
    ...
    public HighClimberCommand(ClimberSubsystem climberSubsystem, ShooterSubsystem shooterSubsystem) {
        ...
        Command driveClimber1 = new MotionProfileClimber(climberSubsystem, -129, 26, 60);
