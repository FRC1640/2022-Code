...
public class Shoot2Balls extends CommandBase{
    ...
    public Shoot2Balls(ShooterSubsystem shooterSubsystem, IntakeSubsystem intakeSubsystem, IndexerSubsystem indexerSubsystem) {
    ...
    public boolean isFinished() {
        ...
        return (val && System.currentTimeMillis() - initTime >= 3000) || System.currentTimeMillis() - startTime >= 5000;
    }
}
