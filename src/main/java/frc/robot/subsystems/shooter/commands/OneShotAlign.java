...
public class OneShotAlign extends CommandBase{
    ...
    public OneShotAlign(ShooterSubsystem shooterSubsystem, IntakeSubsystem intakeSubsystem, IndexerSubsystem indexerSubsystem) {
    ...
    public boolean isFinished() {
        ...
        return (val && System.currentTimeMillis() - initTime >= 800) || System.currentTimeMillis() - startTime >= 2000;
    }
}
