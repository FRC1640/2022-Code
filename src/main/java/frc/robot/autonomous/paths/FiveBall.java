...
public class FiveBall implements PathInterface{
    ...
    public Command getAutoCommand(){
        ...
        SequentialCommandGroup intakeThing = new SequentialCommandGroup(returnPathGroup, stop5, new PrintCommand("AutonTest"), shootIntake, new PrintCommand("AutonFinish"));
