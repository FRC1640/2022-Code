...
public class TwoBallOther implements PathInterface{
    PathPlannerTrajectory twoBall = PathPlanner.loadPath("TwoBallOther", 3.5, 4);
    ...
    public Command getAutoCommand(){
        ...
        Command setOffset = new SetOffset(swerve, shooterSubsystem, -135);
        ...
        Command pointTurret1 = new PointTurret(shooterSubsystem, 66);
        ...
        ParallelDeadlineGroup twoBallGroup = new ParallelDeadlineGroup(twoBallController, intakeWhileDriving, twoBallController, pointTurret1, climb);
        ...
        SequentialCommandGroup fiveBall = new SequentialCommandGroup(resetGyro, setOffset, resetOdo2Ball, twoBallGroup, alignShoot1);
